...
$CFG->dbhost    = getenv('DB_1_PORT_3306_TCP_ADDR');  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = getenv('DB_1_ENV_MYSQL_DATABASE');     // database name, eg moodle
$CFG->dbuser    = getenv('DB_1_ENV_MYSQL_USER');   // your database username
$CFG->dbpass    = getenv('DB_1_ENV_MYSQL_PASSWORD');   // your database password
...
$CFG->dboptions = array(
  ...
  'dbport'    => getenv('DB_1_PORT_3306_TCP_PORT'),          // the TCP port number to use when connecting
